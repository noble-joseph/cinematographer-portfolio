...
export interface ApiJourneyJourney extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Field logs, travel and motorsport journeys';
    displayName: 'Journey';
    pluralName: 'journeys';
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['Motorsport Log', 'Travel Field Note', 'BTS', 'Design Note']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<
      ['Brand Film', 'Motorsport Film', 'Travel Film', 'Design System']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    values: Schema.Attribute.Component<'values.tags', true>;
